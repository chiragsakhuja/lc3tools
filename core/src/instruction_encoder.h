...
namespace core
{
    ...
    public:
        ...
        bool findInstruction(Token const * search, std::vector<Instruction const *> & candidates) const;
    ...
    private:
        std::map<std::string, std::vector<Instruction const *>> instructions_by_name;
    };
};
